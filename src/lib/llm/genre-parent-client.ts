import { z } from 'zod';
import { callAnthropic, type MessageTransport, type Observed } from './transport';
 ...
 *
 * **A truncated tree is worse than no tree**, so the client refuses one rather
 * than proposing a partial taxonomy — nesting some genres and silently leaving
 * others is a hierarchy the user did not choose.
 */
